...
<div class="page-title-overlap bg-dark pt-4">
  <div class="container d-lg-flex justify-content-between py-2 py-lg-3">
	<div class="order-lg-2 mb-3 mb-lg-0 pt-lg-2">
	  <nav aria-label="breadcrumb">
		<ol class="breadcrumb breadcrumb-light flex-lg-nowrap justify-content-center justify-content-lg-start">
		  ...
		  <li class="breadcrumb-item text-nowrap active"><a href="{{url('contact_us')}}">Contact Us</a>
		  </li>
	...
	<div class="order-lg-1 pe-lg-4 text-center text-lg-start">
	  <h1 class="h3 text-light mb-2">Contact Us</h1>
	</div>
  </div>
</div>
<section class="container-fluid pt-grid-gutter">
  <div class="row">
    <div class="col-xl-3 col-sm-6 mb-grid-gutter"><a class="card h-100" href="https://www.google.com/maps/place/{{App\Models\Setting::address()}}" target="_blank">
        <div class="card-body text-center"><i class="ci-location h3 mt-2 mb-4 text-primary"></i>
          <h3 class="h6 mb-2">Main store address</h3>
          <p class="fs-sm text-muted">{{App\Models\Setting::address()}}</p>
      ...
      <div class="card h-100">
        <div class="card-body text-center"><i class="ci-phone h3 mt-2 mb-4 text-primary"></i>
          ...
          <ul class="list-unstyled fs-sm mb-0">
            ...
            <li class="mb-0"><span class="text-muted me-1">Tech support:</span><a class="nav-link-style" href="tel:{{App\Models\Setting::phone()}}">{{App\Models\Setting::phone()}}</a></li>
          </ul>
        </div>
      </div>
    </div>
      ...
      <div class="card h-100">
        <div class="card-body text-center"><i class="ci-mail h3 mt-2 mb-4 text-primary"></i>
          ...
          <ul class="list-unstyled fs-sm mb-0">
            ...
            <li class="mb-0"><span class="text-muted me-1">Tech support:</span><a class="nav-link-style" href="mailto:{{App\Models\Setting::email()}}">{{App\Models\Setting::email()}}</a></li>
          </ul>
        </div>
      </div>
    </div>
