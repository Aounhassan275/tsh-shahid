...
<div class="row mb-2 mb-xl-4">
    ...
    <h3>Add Brand | {{App\Models\Setting::siteName()}}</h3>
    </div>
</div>
<div class="row">
    <div class="col-12">
...
<div class="col-12 ">
    <div class="card">
        <div class="card-header">
            <h5 class="card-title">View Brands</h5>
        </div>
        <table class="table" id="datatables-reponsive">
            ...
            <tbody>
                ...
                <tr>
                    <td>{{$key+1}}</td>
                    <td><img src="{{asset($brand->image)}}" height="100" width="100" alt=""></td>
                    <td>{{$brand->name}}</td>
                    <td>{{$brand->category->name}}</td>
                    <td>
                        <button data-toggle="modal" data-target="#edit_modal" name="{{$brand->name}}" 
                                category_id="{{$brand->category_id}}"  id="{{$brand->id}}" class="edit-btn btn btn-primary">Edit</button>
                        </td>
                    <td>
        ...
        <form id="updateForm" method="POST" enctype="multipart/form-data">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="title">Brand Category</label>
